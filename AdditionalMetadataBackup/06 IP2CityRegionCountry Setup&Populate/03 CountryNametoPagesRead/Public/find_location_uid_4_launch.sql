--DROP FUNCTION find_location_uid_4_launch_fctn() CASCADE;

CREATE OR REPLACE FUNCTION find_location_uid_4_launch_fctn()
RETURNS trigger AS $find_location_uid_4_launch_fctn$
...
RETURN NEW;
END;
$find_location_uid_4_launch_fctn$ LANGUAGE plpgsql;

--DROP FUNCTION populate_location_uid_create_book_fctn();

CREATE OR REPLACE FUNCTION populate_location_uid_create_book_fctn()
...
SELECT * FROM populate_location_uid_create_book_fctn();
commit;
...
select * from bloomapp.create_book where location_uid is  null;
--DROP FUNCTION populate_location_uid_created_fctn();

CREATE OR REPLACE FUNCTION populate_location_uid_created_fctn()
...
DECLARE xyz CURSOR FOR SELECT * from bloomapp.created AS a
...
SELECT * FROM populate_location_uid_created_fctn();
commit;
...
select * from bloomapp.created where location_uid is  null;
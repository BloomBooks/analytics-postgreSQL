--DROP FUNCTION ACTUALmigrate_MPData_CreateNewVernacularCollection();

CREATE OR REPLACE FUNCTION ACTUALmigrate_MPData_CreateNewVernacularCollection()
...
SELECT MIN(b.timestamp) FROM bloomapp.create_new_vernacular_collection AS b 
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO  bloomapp.create_new_vernacular_collection as s  
...
-- Column: bloomapp.create_new_vernacular_collection.location_uid
-- ALTER TABLE bloomapp.create_new_vernacular_collection DROP COLUMN location_uid;
ALTER TABLE bloomapp.create_new_vernacular_collection
    ADD COLUMN location_uid bigint;	
--SELECT * FROM ACTUALmigrate_MPData_CreateNewVernacularCollection();

select * from bloomapp.create_new_vernacular_collection;
SELECT * from bloomreadertest.clone_create_new_vernacular_collection AS a;

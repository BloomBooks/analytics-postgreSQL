--DROP FUNCTION ACTUALmigrate_CreateBloomPack();

CREATE OR REPLACE FUNCTION ACTUALmigrate_CreateBloomPack()
...
SELECT MIN(b.timestamp) FROM bloomapp.create_bloom_pack AS b 
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO  bloomapp.create_bloom_pack as s  
...
--SELECT * FROM ACTUALmigrate_CreateBloomPack();
...
select Count(*) from bloomapp.create_bloom_pack;

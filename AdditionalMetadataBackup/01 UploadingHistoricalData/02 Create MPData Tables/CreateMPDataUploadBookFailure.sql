-- Table: bloomreadertest.mpdata_upload_book_failure

-- DROP TABLE bloomreadertest.mpdata_upload_book_failure;
...
ALTER TABLE bloomreadertest.mpdata_upload_book_failure
    OWNER to segment;
...
GRANT ALL ON TABLE bloomreadertest.mpdata_upload_book_failure TO segment;

select * from bloomreadertest.mpdata_upload_book_failure;
SELECT MIN(b.timestamp) FROM bloomreadertest.mpdata_upload_book_failure AS b;
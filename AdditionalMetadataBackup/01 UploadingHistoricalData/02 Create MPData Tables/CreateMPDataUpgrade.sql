-- Table: bloomreadertest.mpdata_upgrade

-- DROP TABLE bloomreadertest.mpdata_upgrade;
...
ALTER TABLE bloomreadertest.mpdata_upgrade
    OWNER to segment;
...
GRANT ALL ON TABLE bloomreadertest.mpdata_upgrade TO segment;

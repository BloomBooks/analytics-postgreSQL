-- Table: bloomreadertest.mpdata_log_out

-- DROP TABLE bloomreadertest.mpdata_log_out;
...
ALTER TABLE bloomreadertest.mpdata_log_out
    OWNER to segment;

GRANT ALL ON TABLE bloomreadertest.mpdata_log_out TO segment;
...
-- Column: bloomreadertest.mpdata_log_out.location_uid
-- ALTER TABLE bloomreadertest.mpdata_log_out DROP COLUMN location_uid;
ALTER TABLE bloomreadertest.mpdata_log_out
...
select * from bloomreadertest.mpdata_log_out;
SELECT MIN(b.timestamp) FROM bloomreadertest.mpdata_log_out AS b;
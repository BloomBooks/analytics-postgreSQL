-- Table: bloomreadertest.mpdata_downloaded_book_failure

-- DROP TABLE bloomreadertest.mpdata_downloaded_book_failure;
...
(
    ...
    --CONSTRAINT mpdata_downloaded_book_failure_pkey PRIMARY KEY (id)
)
WITH (
    OIDS = FALSE
)
...
ALTER TABLE bloomreadertest.mpdata_downloaded_book_failure
    OWNER to segment;
...
GRANT ALL ON TABLE bloomreadertest.mpdata_downloaded_book_failure TO segment;

select * from bloomreadertest.mpdata_downloaded_book_failure;
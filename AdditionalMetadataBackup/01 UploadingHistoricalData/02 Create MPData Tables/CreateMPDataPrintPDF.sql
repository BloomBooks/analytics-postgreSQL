-- Table: bloomreadertest.mpdata_print_pdf

-- DROP TABLE bloomreadertest.mpdata_print_pdf;
...
ALTER TABLE bloomreadertest.mpdata_print_pdf
    OWNER to segment;
...
GRANT ALL ON TABLE bloomreadertest.mpdata_print_pdf TO segment;

	
select * from bloomreadertest.mpdata_print_pdf;
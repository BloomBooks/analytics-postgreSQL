-- Table: bloomreadertest.mpdata_register

-- DROP TABLE bloomreadertest.mpdata_register;
...
ALTER TABLE bloomreadertest.mpdata_register
    OWNER to segment;
...
GRANT ALL ON TABLE bloomreadertest.mpdata_register TO segment;

select * from bloomreadertest.mpdata_register ;
SELECT MIN(b.timestamp) FROM bloomreadertest.mpdata_register AS b;

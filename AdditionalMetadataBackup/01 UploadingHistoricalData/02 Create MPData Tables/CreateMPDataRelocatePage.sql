-- Table: bloomreadertest.mpdata_relocate_page

-- DROP TABLE bloomreadertest.mpdata_relocate_page;
...
ALTER TABLE bloomreadertest.mpdata_relocate_page
    OWNER to segment;
...
GRANT ALL ON TABLE bloomreadertest.mpdata_relocate_page TO segment;
	
	
select * from bloomreadertest.mpdata_relocate_page;
SELECT MIN(b.timestamp) FROM bloomreadertest.mpdata_relocate_page AS b;
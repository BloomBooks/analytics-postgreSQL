-- Table: bloomreadertest.clone_change_page_layout

-- DROP TABLE bloomreadertest.clone_change_page_layout;

CREATE TABLE bloomreadertest.clone_change_page_layout
(
    ...
    CONSTRAINT clone_change_page_layout_pkey PRIMARY KEY (id)
)
WITH (
    OIDS = FALSE
)
...
ALTER TABLE bloomreadertest.clone_change_page_layout
    OWNER to segment;
	

GRANT SELECT ON TABLE bloomreadertest.clone_change_page_layout TO bloomappuser;
GRANT SELECT ON TABLE bloomreadertest.clone_change_page_layout TO readbloomtester;
GRANT ALL ON TABLE bloomreadertest.clone_change_page_layout TO segment;	
	
-- Column: bloomreadertest.clone_change_page_layout.location_uid
-- ALTER TABLE bloomreadertest.clone_change_page_layout DROP COLUMN location_uid;
ALTER TABLE bloomreadertest.clone_change_page_layout

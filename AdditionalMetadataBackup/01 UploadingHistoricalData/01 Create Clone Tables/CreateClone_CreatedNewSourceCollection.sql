-- Table: bloomreadertest.clone_created_new_source_collection

-- DROP TABLE bloomreadertest.clone_created_new_source_collection;

CREATE TABLE bloomreadertest.clone_created_new_source_collection
(
    ...
    CONSTRAINT clone_created_new_source_collection_pkey PRIMARY KEY (id)
)
WITH (
    OIDS = FALSE
)
...
GRANT SELECT ON TABLE bloomreadertest.clone_created_new_source_collection TO bloomappuser;
GRANT SELECT ON TABLE bloomreadertest.clone_created_new_source_collection TO readbloom;
GRANT ALL ON TABLE bloomreadertest.clone_created_new_source_collection TO segment;

-- Column: bloomreadertest.clone_created_new_source_collection.location_uid
-- ALTER TABLE bloomreadertest.clone_created_new_source_collection DROP COLUMN location_uid;
ALTER TABLE bloomreadertest.clone_created_new_source_collection

-- Table: bloomreadertest.clone_save_e_pub

-- DROP TABLE bloomreadertest.clone_save_e_pub;

CREATE TABLE bloomreadertest.clone_save_e_pub
(
    ...
    CONSTRAINT clone_save_e_pub_pkey PRIMARY KEY (id)
)
WITH (
    OIDS = FALSE
)
...
GRANT SELECT ON TABLE bloomreadertest.clone_save_e_pub TO bloomappuser;
GRANT SELECT ON TABLE bloomreadertest.clone_save_e_pub TO readbloom;
GRANT ALL ON TABLE bloomreadertest.clone_save_e_pub TO segment;


-- ALTER TABLE bloomreadertest.clone_save_epub DROP COLUMN location_uid;
ALTER TABLE bloomreadertest.clone_save_e_pub
    ADD COLUMN location_uid bigint;	
	
select * from bloomreadertest.clone_save_e_pub;

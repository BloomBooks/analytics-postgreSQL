--DROP FUNCTION migrate_MPData_Register();

CREATE OR REPLACE FUNCTION migrate_MPData_Register()
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO bloomreadertest.clone_register as s  
...
--SELECT * FROM migrate_MPData_Register();
...
select count(*) from bloomapp.clone_register;

--DROP FUNCTION migrate_MPData_log_out();

CREATE OR REPLACE FUNCTION migrate_MPData_log_out()
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO bloomreadertest.clone_log_out as s  

--DROP FUNCTION migrate_MPData_upgrade();

CREATE OR REPLACE FUNCTION migrate_MPData_upgrade()
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO bloomreadertest.clone_upgrade as s  
...
-- Column: bloomreadertest.clone_upgrade.location_uid
...
--SELECT * FROM migrate_MPData_upgrade();

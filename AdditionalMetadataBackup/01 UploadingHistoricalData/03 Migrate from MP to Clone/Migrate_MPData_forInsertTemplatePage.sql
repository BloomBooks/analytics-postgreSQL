--DROP FUNCTION migrate_MPData_InsertTemplatePage();

CREATE OR REPLACE FUNCTION migrate_MPData_InsertTemplatePage()
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO  bloomreadertest.clone_insert_template_page as s  
...
--SELECT * FROM migrate_MPData_InsertTemplatePage();

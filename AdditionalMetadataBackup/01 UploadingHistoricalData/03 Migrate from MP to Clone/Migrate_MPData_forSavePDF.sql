--DROP FUNCTION migrate_MPData_save_pdf();

CREATE OR REPLACE FUNCTION migrate_MPData_save_pdf()
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO bloomreadertest.clone_save_pdf as s  
...
-- Column: bloomreadertest.clone_save_pdf.location_uid
...
--SELECT * FROM migrate_MPData_save_pdf();

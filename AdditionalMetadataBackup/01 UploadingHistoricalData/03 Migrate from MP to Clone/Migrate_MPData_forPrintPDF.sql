--DROP FUNCTION migrate_MPData_PrintPDF();

CREATE OR REPLACE FUNCTION migrate_MPData_PrintPDF()
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO bloomreadertest.clone_print_pdf as s  
...
--SELECT * FROM migrate_MPData_PrintPDF();

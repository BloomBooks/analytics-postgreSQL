--DROP FUNCTION migrate_MPData_ExportToDocFormat();

CREATE OR REPLACE FUNCTION migrate_MPData_ExportToDocFormat()
...
SELECT MIN(b.timestamp) FROM bloomreadertest.clone_exported_to_doc_format AS b 
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO  bloomreadertest.clone_exported_to_doc_format as s  
...
--SELECT * FROM migrate_MPData_ExportToDocFormat();
select count(*) from bloomreadertest.clone_exported_to_doc_format;

--DROP FUNCTION migrate_MPData_ExportedXMLforInDesign();

CREATE OR REPLACE FUNCTION migrate_MPData_ExportedXMLforInDesign()
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO  bloomreadertest.clone_exported_xml_for_in_design as s  
...
--SELECT * FROM migrate_MPData_ExportedXMLforInDesign();
select count(*) from bloomreadertest.clone_exported_xml_for_in_design;
select count(*) from bloomapp.change_picture;s

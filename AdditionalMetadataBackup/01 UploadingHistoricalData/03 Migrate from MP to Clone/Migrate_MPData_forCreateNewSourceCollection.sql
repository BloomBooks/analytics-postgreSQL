--DROP FUNCTION migrate_MPData_CreateNewSourceCollection();

CREATE OR REPLACE FUNCTION migrate_MPData_CreateNewSourceCollection()
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO  bloomreadertest.clone_created_new_source_collection as s  
...
-- Column: bloomapp.clone_created_new_source_collection.location_uid
-- ALTER TABLE bloomapp.clone_created_new_source_collection DROP COLUMN location_uid;
ALTER TABLE bloomreadertest.clone_created_new_source_collection
    ADD COLUMN location_uid bigint;	
--SELECT * FROM migrate_MPData_CreateNewSourceCollection();

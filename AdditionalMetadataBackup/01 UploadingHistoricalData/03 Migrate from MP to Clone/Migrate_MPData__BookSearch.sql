--DROP FUNCTION migrate_MPData_book_search();

CREATE OR REPLACE FUNCTION migrate_MPData_book_search()
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO bloomreadertest.clone_book_search as s  
...
--SELECT * FROM migrate_MPData_book_search();

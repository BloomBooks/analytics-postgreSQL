--DROP FUNCTION migrate_MPData_log_in();

CREATE OR REPLACE FUNCTION migrate_MPData_log_in()
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO bloomreadertest.clone_log_in as s  
...
SELECT * from bloomreadertest.mpdata_upload_book_success AS a
	...
	SET  context_library_name = context_library_name||' via Mixpanel';
   	...
   	UPDATE bloomreadertest.clone_log_in
	SET  context_library_name = context_library_name||' via Mixpanel'

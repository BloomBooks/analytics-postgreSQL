--DROP FUNCTION migrate_MPData_ChangePicture();

CREATE OR REPLACE FUNCTION migrate_MPData_ChangePicture()
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO  bloomreadertest.clone_change_picture as s  
...
--SELECT * FROM migrate_MPData_ChangePicture();
select count(*) from bloomapp.change_video;

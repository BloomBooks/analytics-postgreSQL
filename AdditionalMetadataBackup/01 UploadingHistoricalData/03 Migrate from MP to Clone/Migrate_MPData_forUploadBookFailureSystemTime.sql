--DROP FUNCTION migrate_MPData_upload_book_failure_system_time();

CREATE OR REPLACE FUNCTION migrate_MPData_upload_book_failure_system_time()
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO bloomreadertest.clone_upload_book_failure_system_time as s  
...
--SELECT * FROM migrate_MPData_upload_book_failure_system_time();

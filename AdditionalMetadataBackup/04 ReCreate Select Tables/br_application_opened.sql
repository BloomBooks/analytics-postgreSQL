-- Table: bloomreader.application_opened

-- DROP TABLE bloomreader.application_opened;
...
ALTER TABLE bloomreader.application_opened
    OWNER to segment;

GRANT SELECT ON TABLE bloomreader.application_opened TO readbloomtester;

GRANT ALL ON TABLE bloomreader.application_opened TO segment;

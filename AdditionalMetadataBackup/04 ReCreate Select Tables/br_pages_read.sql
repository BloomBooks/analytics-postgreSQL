-- Table: bloomreader.pages_read

-- DROP TABLE bloomreader.pages_read;
...
GRANT ALL ON TABLE bloomreader.pages_read TO segment;

-- Index: language_idx1

-- DROP INDEX bloomreader.language_idx1;

CREATE INDEX language_idx1
    ON bloomreader.pages_read USING btree
    (content_lang COLLATE pg_catalog."default")
    TABLESPACE pg_default;

-- Index: title_idx1

-- DROP INDEX bloomreader.title_idx1;

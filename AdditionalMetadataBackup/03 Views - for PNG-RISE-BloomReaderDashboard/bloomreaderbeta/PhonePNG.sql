REVOKE SELECT ON bloomreaderbeta.phonesPNG FROM readbloomtester;
DROP VIEW bloomreaderbeta.phonesPNG;
...
GRANT SELECT ON bloomreaderbeta.phonesPNG TO readbloomtester;

-- Table: bloomreaderbeta.questions_correct

-- DROP TABLE bloomreaderbeta.questions_correct;
...
GRANT ALL ON TABLE bloomreaderbeta.questions_correct TO segment;

-- Index: title_idx2

-- DROP INDEX bloomreaderbeta.title_idx2;

CREATE INDEX title_idx2
    ON bloomreaderbeta.questions_correct USING btree

-- Table: bloomreadertest.application_opened

-- DROP TABLE bloomreadertest.application_opened;
...
ALTER TABLE bloomreadertest.application_opened
    OWNER to segment;

GRANT SELECT ON TABLE bloomreadertest.application_opened TO readbloomtester;

GRANT ALL ON TABLE bloomreadertest.application_opened TO segment;
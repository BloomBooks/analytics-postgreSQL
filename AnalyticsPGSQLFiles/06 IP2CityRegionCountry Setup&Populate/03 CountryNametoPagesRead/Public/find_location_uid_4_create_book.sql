--DROP FUNCTION find_location_uid_4_create_book_fctn() CASCADE;

CREATE OR REPLACE FUNCTION find_location_uid_4_create_book_fctn()
RETURNS trigger AS $find_location_uid_4_create_book_fctn$
...
RETURN NEW;
END;
$find_location_uid_4_create_book_fctn$ LANGUAGE plpgsql;

--DROP FUNCTION find_location_uid_4_app_installed_fctn() CASCADE;

CREATE OR REPLACE FUNCTION find_location_uid_4_app_installed_fctn()
RETURNS trigger AS $find_location_uid_4_app_installed_fctn$
...
RETURN NEW;
END;
$find_location_uid_4_app_installed_fctn$ LANGUAGE plpgsql;

...
-- The name is confusing, but this converts from an IP address in standard IPv4 (127.0.0.1) or standard IPv6 (sort of...)
...
BEGIN
	...
	ELSE
         IF STRPOS(ip,':') > 0 THEN
			...
			-- In this notation, Octet8 should contain decimal 2002, and Octet7 and Octet6 encode the IPv4 address.

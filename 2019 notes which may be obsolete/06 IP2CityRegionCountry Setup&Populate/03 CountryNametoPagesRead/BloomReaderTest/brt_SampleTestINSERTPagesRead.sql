INSERT INTO bloomreadertest.pages_read(
...
('1ba71f1b-d8eb-4000-ae65-0f5a38651d56',TIMESTAMP '2017-10-04 14:54:44+00',NULL,'30cc7568-bd93-43ea-813d-ad6c2710ea16',100085,
 ...
 select bloomreadertest.pages_read.country_name from bloomreadertest.pages_read 
 where bloomreadertest.pages_read.id='1ba71f1b-d8eb-4000-ae65-0f5a38651d56';
 
 select a.country_name from public.ip2loc_sm_tab as a where a.context_ip = public.ip2int('108.177.6.56');
 
 DELETE FROM bloomreadertest.pages_read WHERE bloomreadertest.pages_read.id='1ba71f1b-d8eb-4000-ae65-0f5a38651d56' RETURNING *;
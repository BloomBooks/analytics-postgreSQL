--DROP FUNCTION ACTUALmigrate_MPData_DeletePage();

CREATE OR REPLACE FUNCTION ACTUALmigrate_MPData_DeletePage()
...
DECLARE xyz CURSOR FOR SELECT * from bloomreadertest.mpdata_delete_page AS a
...
SELECT MIN(b.timestamp) FROM bloomapp.delete_page AS b 
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO bloomapp.delete_page as s  
...
select * from bloomapp.delete_page;
-- Column: bloomapp.delete_page.location_uid
-- ALTER TABLE bloomapp.delete_page DROP COLUMN location_uid;
ALTER TABLE bloomapp.delete_page 
    ADD COLUMN location_uid bigint;	
--SELECT * FROM ACTUALmigrate_MPData_DeletePage();

select * from bloomreadertest.clone_delete_page;
SELECT MIN(b.timestamp) FROM bloomreadertest.clone_delete_page AS b
SELECT * from bloomreadertest.clone_delete_page AS a

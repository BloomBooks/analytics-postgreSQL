--DROP FUNCTION migrate_MPData_pages();

CREATE OR REPLACE FUNCTION migrate_MPData_pages()
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO bloomreadertest.clone_pages   

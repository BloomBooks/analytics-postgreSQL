--DROP FUNCTION migrate_MPData_DownloadedBookFailure();

CREATE OR REPLACE FUNCTION migrate_MPData_DownloadedBookFailure()
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO bloomreadertest.clone_downloaded_book_failure as s  
...
ALTER TABLE bloomreadertest.clone_downloaded_book_failure
    ADD COLUMN location_uid bigint;	
--SELECT * FROM migrate_MPData_DownloadedBookFailure();

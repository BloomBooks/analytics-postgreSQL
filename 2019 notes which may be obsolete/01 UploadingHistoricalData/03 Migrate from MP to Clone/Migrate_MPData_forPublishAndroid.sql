--DROP FUNCTION migrate_MPData_PublishAndroid();

CREATE OR REPLACE FUNCTION migrate_MPData_PublishAndroid()
...
FOR xyz_row IN xyz
	...
	*/
	...
	END IF;
   	...
   	INSERT INTO bloomreadertest.clone_publish_android as s  
...
--SELECT * FROM migrate_MPData_PublishAndroid();

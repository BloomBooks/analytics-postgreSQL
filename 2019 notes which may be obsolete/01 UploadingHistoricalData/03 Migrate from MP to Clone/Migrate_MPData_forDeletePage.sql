--DROP FUNCTION migrate_MPData_DeletePage();

CREATE OR REPLACE FUNCTION migrate_MPData_DeletePage()
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO bloomreadertest.clone_delete_page as s  
...
-- Column: bloomreadertest.clone_delete_page.location_uid
-- ALTER TABLE bloomreadertest.clone_delete_page DROP COLUMN location_uid;
ALTER TABLE bloomreadertest.clone_delete_page
    ADD COLUMN location_uid bigint;	
--SELECT * FROM migrate_MPData_DeletePage();

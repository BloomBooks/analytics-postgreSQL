--DROP FUNCTION migrate_MPData_upload_book_failure();

CREATE OR REPLACE FUNCTION migrate_MPData_upload_book_failure()
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO bloomreadertest.clone_upload_book_failure as s  
...
-- Column: bloomreadertest.clone_upload_book_failure.location_uid
-- ALTER TABLE bloomreadertest.clone_upload_book_failure DROP COLUMN location_uid;
ALTER TABLE bloomreadertest.clone_upload_book_failure
    ADD COLUMN location_uid bigint;	
	
SELECT MIN(b.timestamp) FROM bloomreadertest.clone_upload_book_failure AS b

--SELECT * FROM migrate_MPData_upload_book_failure();

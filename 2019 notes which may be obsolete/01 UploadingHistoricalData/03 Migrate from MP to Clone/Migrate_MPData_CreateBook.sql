--DROP FUNCTION migrate_MPDate_CreateBook();

CREATE OR REPLACE FUNCTION migrate_MPDate_CreateBook()
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO  bloomreadertest.clone_create_book as s  
...
-- ALTER TABLE bloomreadertest.clone_create_book DROP COLUMN location_uid;
ALTER TABLE bloomreadertest.clone_create_book
    ADD COLUMN location_uid bigint;	
	
--SELECT * FROM migrate_MPDate_CreateBook();

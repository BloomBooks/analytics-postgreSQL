--DROP FUNCTION migrate_MPData_CreateNewVernacularCollection();

CREATE OR REPLACE FUNCTION migrate_MPData_CreateNewVernacularCollection()
...
DECLARE xyz CURSOR FOR SELECT * from bloomreadertest.mpdata_create_new_vernacular_collection AS a
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO  bloomreadertest.clone2_create_new_vernacular_collection as s  
...
--SELECT * FROM migrate_MPData_CreateNewVernacularCollection();
...
SELECT a.country,a.ip from bloomreadertest.clone2_create_new_vernacular_collection AS a
  WHERE location_uid = 1;

--DROP FUNCTION migrate_MPData_download_book();

CREATE OR REPLACE FUNCTION migrate_MPData_download_book()
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO bloomreadertest.clone_download_book as s  
...
--SELECT * FROM migrate_MPData_download_book();

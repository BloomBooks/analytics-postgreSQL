--DROP FUNCTION migrate_MPData_save_e_pub();

CREATE OR REPLACE FUNCTION migrate_MPData_save_e_pub()
...
FOR xyz_row IN xyz
	...
	END IF;
   	...
   	INSERT INTO bloomreadertest.clone_save_e_pub as s  
...
-- Column: bloomreadertest.clone_save_e_pub.location_uid
-- ALTER TABLE bloomreadertest.clone_save_e_pub DROP COLUMN location_uid;
ALTER TABLE bloomreadertest.clone_save_e_pub
    ADD COLUMN location_uid bigint;	
	
SELECT MIN(b.timestamp) FROM bloomreadertest.clone_save_e_pub AS b

--SELECT * FROM migrate_MPData_save_e_pub();

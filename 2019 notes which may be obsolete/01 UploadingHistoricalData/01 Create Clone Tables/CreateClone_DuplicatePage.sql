-- Table: bloomreadertest.clone_duplicate_page

-- DROP TABLE bloomreadertest.clone_duplicate_page;

CREATE TABLE bloomreadertest.clone_duplicate_page
(
    ...
    CONSTRAINT clone_duplicate_page_pkey PRIMARY KEY (id)
)
WITH (
    OIDS = FALSE
)
...
ALTER TABLE bloomreadertest.clone_duplicate_page
    OWNER to segment;

GRANT SELECT ON TABLE bloomreadertest.clone_duplicate_page TO bloomappuser;
GRANT SELECT ON TABLE bloomreadertest.clone_duplicate_page TO readbloom;
GRANT ALL ON TABLE bloomreadertest.clone_duplicate_page TO segment;

-- Column: bloomreadertest.clone_duplicate_page.location_uid
-- ALTER TABLE bloomreadertest.clone_duplicate_page DROP COLUMN location_uid;
ALTER TABLE bloomreadertest.clone_duplicate_page
    ADD COLUMN location_uid bigint;	
	
	
select * from bloomreadertest.clone_duplicate_page;
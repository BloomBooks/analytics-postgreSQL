-- Table: bloomreadertest.clone_downloaded_book_failure

-- DROP TABLE bloomreadertest.clone_downloaded_book_failure;

CREATE TABLE bloomreadertest.clone_downloaded_book_failure
(
    ...
    CONSTRAINT clone_downloaded_book_failure_pkey PRIMARY KEY (id)
)
WITH (
    OIDS = FALSE
)
...
GRANT SELECT ON TABLE bloomreadertest.clone_downloaded_book_failure TO bloomappuser;
GRANT SELECT ON TABLE bloomreadertest.clone_downloaded_book_failure TO readbloom;
GRANT ALL ON TABLE bloomreadertest.clone_downloaded_book_failure TO segment;

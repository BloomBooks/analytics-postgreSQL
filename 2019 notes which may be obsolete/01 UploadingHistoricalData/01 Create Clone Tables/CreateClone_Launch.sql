-- Table: bloomreadertest.clone_launch

-- DROP TABLE bloomreadertest.clone_launch;
...
(
    ...
    CONSTRAINT clone_launch_pkey PRIMARY KEY (id)
)
WITH (
    OIDS = FALSE
)
...
GRANT ALL ON TABLE bloomreadertest.clone_launch TO segment;
...
select * from bloomreadertest.clone_launch;

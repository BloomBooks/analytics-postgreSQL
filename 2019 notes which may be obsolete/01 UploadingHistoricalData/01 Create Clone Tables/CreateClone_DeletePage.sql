-- Table: bloomreadertest.clone_delete_page

-- DROP TABLE bloomreadertest.clone_delete_page;
...
(
    ...
    CONSTRAINT clone_delete_page_pkey PRIMARY KEY (id)
)
WITH (
    OIDS = FALSE
)
...
GRANT ALL ON TABLE bloomreadertest.clone_delete_page TO segment;

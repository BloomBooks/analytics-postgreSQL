-- Table: bloomreadertest.mpdata_exported_to_doc_format

-- DROP TABLE bloomreadertest.mpdata_exported_to_doc_format;
...
ALTER TABLE bloomreadertest.mpdata_exported_to_doc_format
    OWNER to segment;
...
GRANT ALL ON TABLE bloomreadertest.mpdata_exported_to_doc_format TO segment;

select * from bloomreadertest.mpdata_exported_to_doc_format;
-- Table: bloomreadertest.mpdata_create_new_vernacular_collection

-- DROP TABLE bloomreadertest.mpdata_create_new_vernacular_collection;
...
ALTER TABLE bloomreadertest.mpdata_create_new_vernacular_collection
    OWNER to segment;
...
GRANT ALL ON TABLE bloomreadertest.mpdata_create_new_vernacular_collection TO segment;

select * from bloomreadertest.mpdata_create_new_vernacular_collection;

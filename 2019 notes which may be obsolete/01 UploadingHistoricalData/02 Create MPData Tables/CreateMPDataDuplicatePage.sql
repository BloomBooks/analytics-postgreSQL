-- Table: bloomreadertest.mpdata_duplicate_page

-- DROP TABLE bloomreadertest.mpdata_duplicate_page;
...
ALTER TABLE bloomreadertest.mpdata_duplicate_page
    OWNER to segment;
...
GRANT ALL ON TABLE bloomreadertest.mpdata_duplicate_page TO segment;

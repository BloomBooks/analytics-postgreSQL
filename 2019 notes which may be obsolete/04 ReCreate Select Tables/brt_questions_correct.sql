-- Table: bloomreadertest.questions_correct

-- DROP TABLE bloomreadertest.questions_correct;
...
ALTER TABLE bloomreadertest.questions_correct
    OWNER to segment;

GRANT SELECT ON TABLE bloomreadertest.questions_correct TO readbloomtester;

GRANT ALL ON TABLE bloomreadertest.questions_correct TO segment;

-- Index: title_idx2

-- DROP INDEX bloomreadertest.title_idx2;

CREATE INDEX title_idx2
    ON bloomreadertest.questions_correct USING btree

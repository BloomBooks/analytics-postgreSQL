-- View: bloomreader.v_pages_read_exp

-- DROP VIEW bloomreader.v_pages_read_exp ;

CREATE OR REPLACE VIEW bloomreader.v_pages_read_exp AS
...
SELECT  pr.timestamp as time_utc,
        ...
        --'abc' 
        -- (select l.clname 
        --     from public.languagecodes l 
        --     where (l.langId2 is not null and pr.content_lang = l.langid2) or pr.content_lang = l.langid)
        --  as book_language,
...
ALTER TABLE bloomreader.v_pages_read_exp OWNER TO silpgadmin;

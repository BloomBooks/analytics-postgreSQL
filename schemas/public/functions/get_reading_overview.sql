-- DROP FUNCTION public.get_reading_overview(BOOLEAN, DATE, DATE, TEXT, TEXT);

CREATE OR REPLACE FUNCTION public.get_reading_overview(
    ...
    RETURNS TABLE (bookCount BIGINT, deviceCount BIGINT, languageCount BIGINT)
AS $$
